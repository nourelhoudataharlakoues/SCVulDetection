...
word2vec_model_code = Word2Vec(df['code_tokens'], vector_size=300, window=5, min_count=1, workers=1, seed=42)
...
param_grids = {
    ...
    "Random Forest": {"n_estimators": [10, 50, 100, 200], "max_depth": [None, 10, 20, 30, 40, 50], "min_samples_split": [2, 5, 10]},
    "SVM": {"C": [0.1, 1, 10, 100], "gamma": ['scale', 'auto'], "kernel": ['linear', 'rbf']},
    "Logistic Regression": {"C": [0.1, 1, 10, 100], "solver": ['newton-cg', 'lbfgs', 'liblinear', 'sag', 'saga']}
}
